 ...
 *
 */
class Magentando_SplitDelivery_Block_Mail_Items extends Mage_Core_Block_Template
{
    public function getSplitDelivery($order)
    {
        $splitDeliveryItems = Mage::helper('core')->jsonDecode($order->getSplitdelivery());
