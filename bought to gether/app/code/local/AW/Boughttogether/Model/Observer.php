...
class AW_Boughttogether_Model_Observer
{
    ...
    public function setEnjoyDiscount($observer)
    {
        //die('teste');
        ...
        foreach( $_itemsCollection as $item )
        {
            ...
            {
                $discount = $discount + $product->getFinalPrice();
            }
        }
        
        
        
       $discount = ( $discount / 100) * Mage::getStoreConfig('boughttogether/general/discount',Mage::app()->getStore());
                ...
                foreach ($quote->getAllAddresses() as $address) {
                    ...
                    if($address->getAddressType()==$canAddItems) {
                        ...
                        if($address->getDiscountDescription()){
                            ...
                            $address->setDiscountDescription('Disconto Combo');
