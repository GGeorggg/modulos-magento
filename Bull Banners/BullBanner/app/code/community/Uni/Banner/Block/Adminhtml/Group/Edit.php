 ...
 */
class Uni_Banner_Block_Adminhtml_Group_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function getHeaderText() {
        if (Mage::registry('group_data') && Mage::registry('group_data')->getId()) {
            return Mage::helper('banner')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('group_data')->getGroupName()));
        } else {
