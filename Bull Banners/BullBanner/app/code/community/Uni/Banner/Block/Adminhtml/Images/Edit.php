 ...
 */
class Uni_Banner_Block_Adminhtml_Images_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
    ...
    public function getHeaderText() {
        if (Mage::registry('images_data') && Mage::registry('images_data')->getId()) {
            return Mage::helper('banner')->__("Edit Item '%s'", $this->htmlEscape(Mage::registry('images_data')->getTitle()));
        } else {
