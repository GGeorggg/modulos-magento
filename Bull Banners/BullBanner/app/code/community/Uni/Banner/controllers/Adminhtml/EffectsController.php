 ...
 */
class Uni_Banner_Adminhtml_EffectsController extends Mage_Adminhtml_Controller_action {
    ...
    public function editAction() {
        ...
        if ($model->getEffectId() || $id == 0) {
            ...
            $this->_addContent($this->getLayout()->createBlock('banner/adminhtml_effects_edit'))
    ...
    public function saveAction()
    {
        ...
        {
            $model = Mage::getModel('banner/effects');
            $id = $this->getRequest()->getParam('id');
            if ($id) {
                $model->load($id);
            }
            ...
            try {
                ...
                if (!$model->getId()) {
                    Mage::throwException(Mage::helper('banner')->__('Error saving example'));
                }
 
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('banner')->__('Example was successfully saved.'));
    ...
    public function deleteAction() {
        if ($this->getRequest()->getParam('id') > 0) {
            try {
                $model = Mage::getModel('banner/effects')->load($this->getRequest()->getParam('id'));
